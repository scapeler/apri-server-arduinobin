/*
** Module: apri-server-arduinobin
**
** System module for arduinobin service handling client requests for arduinobin like R graphs etc.
**
*/
...
var _jsFile = 'abcdefgh';
  ...
  //  res.setHeader('x-MD5','cfbc6bb28926ce99fb75c554d75f49cd');
    res.setHeader('x-MD5','2c4fc2b55e1f2554f3eb8036254c528d');
...
app.get('/'+apriConfig.systemCode+'/arduinobin/graphviz/*.png', function(req, res) {
  //console.log("YUI request: " + req.url );
  try {
    var url = req.url.replace(/\.\./gi,'');
    var _jsFile=fs.readFileSync(systemFolderRoot + url);
